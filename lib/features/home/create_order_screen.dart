...
import 'package:refer_app/core/utils/widgets/text_form_field.dart';
...
class _CreateOrderScreenState extends State<CreateOrderScreen> {
  ...
  Widget build(BuildContext context) {
    return Column(children: [_takeAway(), _menu(), _coffeeList()]);
  }
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: DropdownButton<String>(
          ...
          items: <String>['Tall', 'Grande', 'Venti']
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      mainAxisAlignment: !showQty[index]
                            ...
                            ? Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Expanded(
                                        child: _buildInputAmountWidget(context),
                                      ),
                                      Container(width: 8),
