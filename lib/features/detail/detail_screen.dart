...
class _DetailScreenState extends State<DetailScreen> {
  ...
  List cupSizeList = [
    {'name': 'T', 'price': 10.50, 'scaleRatio': 3.0},
    {'name': 'G', 'price': 12.25, 'scaleRatio': 2.5},
    {'name': 'V', 'price': 17.75, 'scaleRatio': 2.0},
  ];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          SvgPicture.asset('assets/icon/notification_bell_icon.svg'),
          const SizedBox(width: 10),
          SvgPicture.asset('assets/icon/three_dots_icon.svg'),
      ...
      body: Column(
        ...
        children: [
          Image.asset('assets/images/coffee1.png', scale: 1.2),
          Padding(
      ...
      child: Row(
        ...
        children: [
          InkWell(
            ...
            child: const Icon(Icons.remove, color: AppColors.darkGrey),
          ),
